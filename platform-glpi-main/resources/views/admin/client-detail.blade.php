...
<div class="d-flex align-items-center gap-2 mb-4">
  <a href="{{ route('admin.clients') }}" class="btn btn-sm btn-outline-secondary mb-0">
  ...
  <div class="col-lg-4">
    ...
    <div class="card mb-4" style="border-radius:16px;overflow:hidden;">
      ...
      <div class="card-body text-center" style="margin-top:-45px;">
        ...
        {{-- Status actif --}}
        <div class="mb-3">
          <span class="badge {{ $client->is_active ? 'bg-gradient-success' : 'bg-gradient-secondary' }}">
        ...
        <div class="d-flex flex-column gap-3">
          ...
          <div class="d-flex align-items-center gap-3">
            ...
            <div>
              ...
              <p class="text-sm font-weight-bold mb-0">
                {{ $client->phone_mobile }}
                @if($client->phone_verified ?? false)
          ...
          <div class="d-flex align-items-center gap-3">
            ...
            <div>
              ...
              <p class="text-sm font-weight-bold mb-0">{{ $client->whatsapp }}</p>
            </div>
          </div>
          @endif
        </div>
