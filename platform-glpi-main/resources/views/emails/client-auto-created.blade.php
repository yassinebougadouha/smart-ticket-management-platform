      ...
      <tr>
        <td style="padding:40px 30px;">
          ...
          <table width="100%" cellpadding="0" cellspacing="0" style="background:#f0f4ff;border-radius:10px;overflow:hidden;margin:0 0 28px;border:1px solid #c3cfe2;">
            <tr>
              <td style="background:linear-gradient(135deg,{{ $_emailPrimary }},{{ $_emailSecondary }});padding:12px 20px;">
              ...
              <td style="padding:20px;">
                <table width="100%" cellpadding="8" cellspacing="0">
                  <tr>
                    ...
                    <td style="color:#2d3748;font-size:14px;font-family:monospace;">{{ $email }}</td>
                  </tr>
                  <tr style="background:#e8eeff;border-radius:6px;">
                    ...
                    <td style="font-size:15px;padding:10px 8px;">
                      <span style="background:#fff;border:1px solid {{ $_emailPrimary }};border-radius:6px;padding:4px 12px;font-family:monospace;font-weight:700;color:{{ $_emailPrimary }};letter-spacing:1px;">{{ $password }}</span>
                    </td>
                  </tr>
                </table>
              </td>
          ...
          <div style="text-align:center;margin:30px 0;">
            <a href="{{ url('/login') }}"
               style="display:inline-block;background:linear-gradient(135deg,{{ $_emailPrimary }},{{ $_emailSecondary }});color:#fff;text-decoration:none;padding:14px 36px;border-radius:8px;font-size:15px;font-weight:600;">
