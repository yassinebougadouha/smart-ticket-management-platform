                ...
                <tr>
                    <td style="padding:40px 30px;">
                        ...
                        <p style="color:#4a5568;font-size:15px;line-height:1.7;margin:0 0 28px;">
                            Bonjour <strong>{{ $ticket->user->name }}</strong>,<br><br>
                        ...
                        <table width="100%" cellpadding="0" cellspacing="0" style="background:#f7fafc;border-radius:10px;overflow:hidden;margin:0 0 28px;border:1px solid #e2e8f0;">
                            <tr>
                                <td style="background:linear-gradient(135deg,{{ $_emailPrimary }},{{ $_emailSecondary }});padding:14px 20px;">
                                    ...
                                    <table width="100%" cellpadding="7" cellspacing="0">
                                        <tr>
                                            ...
                                            <td style="font-size:14px;">
                                                <span style="background:linear-gradient(135deg,{{ $_emailPrimary }},{{ $_emailSecondary }});color:#fff;padding:3px 12px;border-radius:20px;font-weight:700;font-size:13px;">#{{ $ticket->id }}</span>
                                            </td>
                                        </tr>
                                        <tr style="background:#edf2f7;">
                                            <td style="color:#718096;font-size:14px;padding:9px 7px;"><strong>Titre</strong></td>
                                            <td style="color:#2d3748;font-size:14px;padding:9px 7px;">{{ $ticket->title }}</td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td style="color:#2d3748;font-size:14px;">
                                                ...
                                                @endphp
                                                {{ $catMap[$ticket->category] ?? $ticket->category }}
                                            </td>
                                        </tr>
                                        <tr style="background:#edf2f7;">
                                            <td style="color:#718096;font-size:14px;padding:9px 7px;"><strong>Priorité</strong></td>
                                            <td style="font-size:14px;padding:9px 7px;">
                                                <span style="background:{{ $prioColors[$ticket->priority] ?? '#f39c12' }};color:#fff;padding:2px 10px;border-radius:12px;font-size:12px;font-weight:600;">
                        ...
                        <!-- Description -->
                        <div style="background:#f0f4ff;border-left:4px solid {{ $_emailPrimary }};border-radius:4px;padding:16px;margin:0 0 28px;">
                            <p style="color:#4c51bf;font-size:13px;margin:0 0 8px;font-weight:700;">📝 Votre description :</p>
                            <p style="color:#434190;font-size:14px;margin:0;line-height:1.7;">{{ Str::limit($ticket->description, 400) }}</p>
                        </div>
                        ...
                        <div style="background:#f0fdf4;border-left:4px solid #22c55e;border-radius:4px;padding:16px;margin:0 0 28px;">
                            <p style="color:#166534;font-size:14px;margin:0;">
                                ...
                                Notre équipe s'engage à traiter votre demande dans un délai de <strong>{{ $sla }}h</strong>.
                            </p>
                        </div>
                        ...
                        <div style="text-align:center;margin:30px 0 10px;">
                            <a href="{{ url('/tickets') }}"
                               style="display:inline-block;background:linear-gradient(135deg,{{ $_emailPrimary }},{{ $_emailSecondary }});color:#fff;text-decoration:none;padding:14px 36px;border-radius:8px;font-size:15px;font-weight:600;letter-spacing:0.3px;">
                                📋 Suivre mes tickets →
                            </a>
                        </div>
