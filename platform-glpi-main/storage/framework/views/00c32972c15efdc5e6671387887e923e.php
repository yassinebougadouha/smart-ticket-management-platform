...
<div class="alert alert-success alert-dismissible fade show border-0 shadow-sm mb-4"
  ...
  <div class="d-flex align-items-center">
    ...
    <span class="font-weight-bold"><?php echo e(session('success') ?: (session('status') === 'profile-updated' ? 'Profil mis à jour avec succès !' : 'Action réussie !')); ?></span>
  </div>
...
<div class="profile-container">
  ...
  <div class="profile-nav">
    ...
    <div class="section-card mt-4 text-center p-4 user-mini-card">
      ...
      <h5 class="mb-1 font-weight-bold text-heading"><?php echo e($user->name); ?></h5>
      <p class="text-xs text-muted mb-3"><?php echo e($user->email); ?></p>
            ...
            <div class="row g-4 mb-4">
              <div class="col-md-6">
                ...
                <input type="text" name="first_name" class="form-control form-control-custom"
                       value="<?php echo e(old('first_name', $user->first_name)); ?>" placeholder="Votre prénom">
              </div>
              <div class="col-md-6">
                <label class="form-label-custom">Nom de famille</label>
                <input type="text" name="last_name" class="form-control form-control-custom"
                       value="<?php echo e(old('last_name', $user->last_name)); ?>" placeholder="Votre nom">
              </div>
              <div class="col-md-6">
                  ...
                  <div class="col-4">
                    <label class="gender-option w-100 mb-0">
                      <input type="radio" name="gender" value="other" class="d-none gender-radio"
                             <?php echo e(old('gender', $user->gender) === 'other' ? 'checked' : ''); ?>>
                      <div class="gender-box">
...
$message = $__bag->first($__errorArgs[0]); ?><div class="text-danger text-xs mt-1"><?php echo e($message); ?></div><?php unset($message);
              ...
              <div class="col-md-6">
                ...
                <div class="input-group">
                  ...
                  <input type="tel" name="phone_mobile" class="form-control form-control-custom"
                         style="border-radius:0 14px 14px 0;"
                         value="<?php echo e(old('phone_mobile', $user->phone_mobile)); ?>" placeholder="216 ...">
                </div>
...
unset($__errorArgs, $__bag); ?>
              ...
              <div class="col-md-6">
                ...
                <input type="tel" name="phone" class="form-control form-control-custom"
                       value="<?php echo e(old('phone', $user->phone)); ?>" placeholder="216 ...">
              </div>
              <div class="col-md-6">
                <label class="form-label-custom">📱 WhatsApp</label>
                <input type="tel" name="whatsapp" class="form-control form-control-custom"
                       value="<?php echo e(old('whatsapp', $user->whatsapp)); ?>" placeholder="216 ...">
              </div>
              <div class="col-md-6">
                ...
                <div class="input-group">
                  ...
                  <input type="email" name="teams_email" id="teamsEmailInput"
                         ...
                         style="border-radius:0 14px 14px 0;"
                         value="<?php echo e(old('teams_email', $user->teams_email)); ?>"
...
unset($__errorArgs, $__bag); ?>
    ...
    <div id="section-appearance" class="profile-section">
      <form id="uiSettingsForm" action="<?php echo e(route('user.settings.ui')); ?>" method="POST">
        <?php echo csrf_field(); ?>
        <div class="section-card">
          <div class="section-header d-flex align-items-center justify-content-between">
            <div>
            ...
            <div class="row g-3 mb-5">
              ...
              <div class="col-4">
                <label class="theme-option w-100 mb-0">
                  <input type="radio" name="theme_mode" value="<?php echo e($val); ?>"
                         class="d-none theme-radio" <?php echo e($themeMode === $val ? 'checked' : ''); ?>>
                  <div class="theme-box shadow-sm">
                    <i class="material-symbols-rounded d-block mb-2 fs-2 text-muted"><?php echo e($d[0]); ?></i>
            ...
            <div class="row g-5 align-items-center">
              <div class="col-lg-6">
                ...
                <div class="palette-grid mb-5">
                  ...
                  <button type="button" class="palette-btn" data-primary="<?php echo e($p); ?>" data-secondary="<?php echo e($s); ?>"
                          style="background:linear-gradient(135deg,<?php echo e($p); ?>,<?php echo e($s); ?>);"></button>
                  <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </div>
                  ...
                  <div class="col-6">
                    ...
                    <div class="d-flex align-items-center gap-2 p-2 bg-body border-radius-lg border">
                      <input type="color" name="primary_color" id="primaryColorPicker"
                             value="<?php echo e($primaryColor); ?>" class="form-control-color border-0 p-0"
                             style="width:28px;height:28px;border-radius:6px;cursor:pointer;">
                      <input type="text" id="primaryColorText" value="<?php echo e($primaryColor); ?>"
                  ...
                  <div class="col-6">
                    ...
                    <div class="d-flex align-items-center gap-2 p-2 bg-body border-radius-lg border">
                      <input type="color" name="secondary_color" id="secondaryColorPicker"
                             value="<?php echo e($secondaryColor); ?>" class="form-control-color border-0 p-0"
                             style="width:28px;height:28px;border-radius:6px;cursor:pointer;">
                      <input type="text" id="secondaryColorText" value="<?php echo e($secondaryColor); ?>"
                             class="form-control form-control-sm border-0 bg-transparent font-monospace text-xs p-0"
                             style="max-width:70px;">
                    </div>
                  </div>
              ...
              <div class="col-lg-6">
                <div class="p-5 border-radius-2xl shadow-lg text-center position-relative overflow-hidden"
                     id="uiPreview"
                     style="background:linear-gradient(135deg,<?php echo e($primaryColor); ?>,<?php echo e($secondaryColor); ?>); min-height:220px; display:flex; flex-direction:column; justify-content:center;">
...
<script>
  ...
  document.getElementById('resetUiBtn').addEventListener('click', () => {
    primaryPicker.value   = primaryText.value   = '<?php echo e($appSettings["primary_color"] ?? "#1a56db"); ?>';
    secondaryPicker.value = secondaryText.value = '<?php echo e($appSettings["secondary_color"] ?? "#764ba2"); ?>';
    updatePreview();
  });
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.dashboard', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/html/resources/views/profile/edit.blade.php ENDPATH**/ ?>