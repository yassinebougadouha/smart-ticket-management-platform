...
<div class="card">
    ...
    <?php if($errors->has('code')): ?>
        <div class="alert-error">❌ <?php echo e($errors->first('code')); ?></div>
    <?php endif; ?>
    ...
    <div class="resend">
        Pas reçu le code ? <a href="<?php echo e(route('2fa.resend')); ?>">Renvoyer</a>
    </div>
</div>
...
</html><?php /**PATH /var/www/html/resources/views/auth/2fa-verify.blade.php ENDPATH**/ ?>