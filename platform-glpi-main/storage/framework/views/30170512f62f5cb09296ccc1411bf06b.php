  ...
  <div id="sidenav-collapse-main" style="padding:4px 8px 12px;">
    <ul class="navbar-nav" style="gap:1px; padding:0; margin:0; list-style:none;">
      ...
      <?php if(auth()->user()->role === 'super_admin'): ?>
        ...
        <li class="nav-item">
          <a class="nav-link <?php echo e(request()->routeIs('super-admin.urgent-tickets') ? 'active text-white' : 'text-dark'); ?>"
             href="<?php echo e(route('super-admin.urgent-tickets')); ?>"
             style="<?php echo e(request()->routeIs('super-admin.urgent-tickets') ? 'background:linear-gradient(135deg,var(--color-primary),var(--color-secondary));' : ''); ?>">
        ...
        <li class="nav-item">
          <a class="nav-link <?php echo e(request()->routeIs('super-admin.chat-access') ? 'active text-white' : 'text-dark'); ?>"
             href="<?php echo e(route('super-admin.chat-access')); ?>"
             style="<?php echo e(request()->routeIs('super-admin.chat-access') ? 'background:linear-gradient(135deg,var(--color-primary),var(--color-secondary));' : ''); ?>">
            <i class="material-symbols-rounded" style="font-size:23px;font-variation-settings:'FILL' 1,'wght' 400,'GRAD' 0,'opsz' 24;flex-shrink:0;">forum</i>
      ...
      <?php elseif(auth()->user()->role === 'admin'): ?>
        ...
        <?php if(auth()->user()->can_reply_conversations): ?>
          <li class="nav-item">
        ...
        <?php if(in_array(auth()->user()->role ?? '', ['admin', 'super_admin'], true)): ?>
          <li class="nav-item">
