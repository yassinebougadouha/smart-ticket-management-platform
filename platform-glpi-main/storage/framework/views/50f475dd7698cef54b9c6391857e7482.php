...
<?php $__env->startSection('page-title', 'Ticket #' . $ticket->id); ?>
...
<div class="d-flex align-items-center mb-4 gap-2">
    ...
    <span class="text-sm font-weight-bold">Ticket #<?php echo e($ticket->id); ?></span>
</div>
    ...
    <div class="col-12 mb-4">
            ...
            <div class="card-body px-4 py-4">
                <div class="d-flex align-items-start justify-content-between flex-wrap gap-2">
                    <div>
                        <div class="d-flex align-items-center gap-2 mb-2">
                            ...
                            <span class="badge bg-gradient-<?php echo e($st[0]); ?> px-2 py-1 text-white">
                                <i class="material-symbols-rounded me-1" style="font-size:13px;vertical-align:middle;"><?php echo e($st[2]); ?></i>
                                <?php echo e($st[1]); ?>

                            </span>
                        </div>
                        <h5 class="font-weight-bolder mb-1"><?php echo e($ticket->title); ?></h5>
                        <p class="text-xs text-secondary mb-0">
                            <i class="material-symbols-rounded me-1" style="font-size:13px;vertical-align:middle;">calendar_today</i>
                            <?php echo e($ticket->created_at->timezone('Africa/Tunis')->format('d/m/Y à H:i')); ?>

                        </p>
                    </div>
                    <div class="text-end">
                        <span class="badge bg-gradient-<?php echo e($prioColors[$ticket->priority] ?? 'warning'); ?> text-white px-2">
                            <?php echo e($prioMap[$ticket->priority] ?? 'Moyenne'); ?>

                        </span><br>
                        <small class="text-secondary text-xs"><?php echo e($cat[0]); ?> <?php echo e($cat[1]); ?></small>
                    </div>
                </div>
                ...
                <div class="mt-3 pt-3 border-top">
                    ...
                    <div class="d-flex flex-wrap gap-2">
                        <?php $__currentLoopData = json_decode($ticket->attachments); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $path): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        ...
        <div class="card mb-4 shadow-sm">
            ...
            <div class="card-body px-4 pb-4">
                <p class="text-sm mb-0" style="line-height:1.8;white-space:pre-wrap;"><?php echo e($ticket->description); ?></p>
            </div>
        </div>
        ...
        <div class="card mb-4 shadow-sm" style="border-left:4px solid #22c55e;">
            ...
            <div class="card-body px-4 pb-4">
                <p class="text-sm mb-0" style="line-height:1.8;white-space:pre-wrap;color:#166534;"><?php echo e($ticket->solution); ?></p>
            </div>
        </div>
        <?php endif; ?>
        ...
        <div class="card mb-4 shadow-sm">
            ...
            <div class="card-body px-4 pb-3">
                ...
                <div class="d-flex gap-3 mb-3 pb-3 <?php echo e(!$loop->last ? 'border-bottom' : ''); ?>">
                    ...
                    <div class="flex-grow-1">
                        <div class="d-flex justify-content-between align-items-center mb-1">
                            <span class="text-sm font-weight-bold"><?php echo e($comment->user->name ?? 'Vous'); ?></span>
                            <span class="text-xs text-secondary">
                                <?php echo e($comment->created_at->timezone('Africa/Tunis')->format('d/m/Y à H:i')); ?>

                            </span>
                        </div>
                        <p class="text-sm mb-0" style="line-height:1.7;"><?php echo e($comment->content); ?></p>
                        ...
                        <div class="mt-2 d-flex flex-wrap gap-2">
                          <?php $__currentLoopData = $paths; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ap): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                          <a href="<?php echo e(asset('storage/' . $ap)); ?>" target="_blank"
                             class="text-xs text-primary d-inline-flex align-items-center gap-1"
        ...
        <?php if($appSettings['allow_client_close'] ?? false): ?>
        ...
        <div class="card shadow-sm border-0 mb-3">
            <div class="card-body px-4 py-3 d-flex align-items-center justify-content-between">
                ...
                <form method="POST" action="<?php echo e(route('tickets.close', $ticket->id)); ?>"
        ...
        <?php if(!in_array($ticket->sync_status, ['resolved', 'closed'])): ?>
        <div class="card shadow-sm">
            ...
            <div class="card-body px-4 pb-4">
                <form method="POST" action="<?php echo e(route('tickets.comment', $ticket->id)); ?>"
        ...
        <div class="alert" style="background:#f0fdf4;border-left:4px solid #22c55e;border-radius:8px;">
            <p class="text-sm mb-0" style="color:#166534;">
                ...
                Ce ticket est <strong><?php echo e($st[1]); ?></strong> — vous ne pouvez plus ajouter de commentaires.
            </p>
        </div>
        <?php endif; ?>
...
function improveComment() {
  ...
  fetch('<?php echo e(route("tickets.reformulate")); ?>', {
    method: 'POST',
    headers: {
    ...
    body: JSON.stringify({
      title: '<?php echo e(addslashes($ticket->title)); ?>',
      description: text
    })
  })
...
<?php echo $__env->make('layouts.dashboard', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/html/resources/views/client/tickets/show.blade.php ENDPATH**/ ?>