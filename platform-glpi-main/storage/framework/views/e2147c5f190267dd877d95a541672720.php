...
<?php $__env->startSection('page-title','Créer un ticket'); ?>
...
<div class="ct-wrap">
<a href="<?php echo e(route('tickets.index')); ?>" class="ct-back">
  ...
  <div class="card-body">
    ...
    <div class="alert alert-danger alert-dismissible fade show mb-3" style="border-radius:10px;">
      <?php $__currentLoopData = $errors->all(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $e): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <p class="text-xs mb-0"><?php echo e($e); ?></p>
      <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
      <button type="button" class="btn-close" data-bs-dismiss="alert"></button>
    </div>
    <?php endif; ?>

    <form method="POST" action="<?php echo e(route('tickets.store')); ?>" enctype="multipart/form-data" id="ticketForm">
      <?php echo csrf_field(); ?>
      ...
      <div class="ct-row">
        ...
        <div class="ct-field">
          ...
          <select name="category" id="categorySelect" class="form-control form-select ct-select"
            ...
            <option value="incident_technique"  <?php echo e(old('category')=='incident_technique'?'selected':''); ?>>🔴 Incident technique</option>
            <option value="integration_api"     <?php echo e(old('category')=='integration_api'?'selected':''); ?>>🔵 Intégration API SMS</option>
            <option value="facturation"         <?php echo e(old('category')=='facturation'?'selected':''); ?>>🟡 Facturation & Commande</option>
            <option value="plateforme"          <?php echo e(old('category')=='plateforme'?'selected':''); ?>>🟢 Plateforme L2T</option>
            <option value="paiement_mobile"     <?php echo e(old('category')=='paiement_mobile'?'selected':''); ?>>🟠 Paiement Mobile</option>
            <option value="autre"               <?php echo e(old('category')=='autre'?'selected':''); ?>>⚪ Autre demande</option>
          </select>
        ...
        <div class="ct-field">
          ...
          <input type="text" name="title" id="ticketTitle" class="form-control"
                 ...
                 value="<?php echo e(old('title')); ?>" required autocomplete="off"
                 style="height:42px;">
...
unset($__errorArgs, $__bag); ?>
      ...
      <div class="ct-field">
        ...
        <textarea name="content" id="ticketContent" class="form-control" rows="4" required
                  placeholder="Expliquez votre problème en détail"><?php echo e(old('content')); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
      ...
      <div class="d-flex justify-content-between align-items-center">
        <a href="<?php echo e(route('tickets.index')); ?>" class="ct-btn-cancel">
...
<?php echo $__env->make('layouts.dashboard', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/html/resources/views/client/tickets/create.blade.php ENDPATH**/ ?>